...
**Earned Hunch** — FULLY APPLIED. Sentence replacement 2026-07-11 (Mind & Myth A1 canon commit); the appended provenance-reading block ("On hunches: …") APPLIED 2026-07-13, verbatim from operator-delivered `cc-prompt-earned-hunch.md` §D (vendored at `docs/build/cc-prompt-earned-hunch.md`). BLOCKERS B-4 resolved; the live rite opens in the same change.
